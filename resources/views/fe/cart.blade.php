                    ...
                    <table class="table table-cart">
                        ...
                        <tbody>
                            ...
                            <tr class="product-row">
                                <td>
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{asset('storage/images')}}/{{$value['image']}}" alt="product" width="70px">
                                        </a>
                                ...
                                <td class="text-right"><span class="subtotal-price">{{number_format($value['quantity']*$value['price'])}} </span></td>
                            </tr>
                            @endforeach  
                        </tbody>
